      ...
      <div class="invite-bonus" v-if="this.currentTab === 2">
        <div class="main-table">
          <p class="main-table-title f-1-cl c-5-bd c-4-bg">
            {{ $t("personal.inviteCodeManagement.commissionRecor") }}
          </p>
          <c-table
            :imgMap="imgMap"
            :colorMap="colorMap"
...
<script>
import mixin from "@/components/BlockChain-ui-privatization/PC/common-mixin/mining/mining";
import "@/components/BlockChain-ui-privatization/PC/common-mixin/mining/mining.styl";
