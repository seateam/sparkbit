            ...
            <div class="home-tbody">
              <div>
                <ul class="home-tbody-list">
                  <li
                    class="home-tbody-li"
                    v-for="(item, index) in setTableData(tableData)"
                    :key="index"
                  ...
                  >
                    ...
                    <div class="even">
                      <span
                        ...
                        class="evenSymbol"
                        @click="bandLink(item.id)"
                      ></span>
                    </div>
                    <!-- 最新价 -->
                    <div class="even newPrice">
                      <p :class="[...item.data[2][0].classes]" class="price">
                        {{item.data[1][0].text}}
                      </p>
                    </div>
                    <!-- 涨跌幅 -->
...
import mixin from '@/components/BlockChain-ui-privatization/PC/common-mixin/home/market/korea/korea';
import '@/components/BlockChain-ui-privatization/PC/common-mixin/home/market/korea/korea.styl';
