<template>
  <section class="internationalHome momo-home-container ">
    <!-- 轮播图 -->
    ...
    <div class="bulletinBoard h-2-bg h-3-bd">
      <template  v-if="noticeList.length > 0">
        <div class="bull-bar">
          ...
          <!-- 更多 -->
          <router-link class="more x-3-cl" to="noticeInfo">全部公告</router-link>
        </div>
      </template>
    </div>
    <!-- 推荐位 -->
...
import '@/components/BlockChain-ui-privatization/PC/common-mixin/home/home/momo/momo.styl';
import SwiperVue from '../swiper/momo.vue';
import Market from '../market/momo.vue';
import Recommend from '../recommend/momo.vue';
// import Custom from '../custom/momo.vue';
