...
<script>
import mixin from "@/components/BlockChain-ui-privatization/PC/common-mixin/futuresData/futuresData";
import "@/components/BlockChain-ui-privatization/PC/common-mixin/futuresData/futuresData.styl";
...
<style scoped>
.futuresData .futuresData-content,
.futuresData .data-content {
  background: var(--color-11);
}
.futuresData .mining-tit .item.selected {
  color: var(--color-1);
}
.con-text > span {
  color: var(--color-1);
