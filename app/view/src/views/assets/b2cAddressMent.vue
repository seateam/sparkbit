<template>
  <section class="page-b2cAddressMent">
    <!-- 添加提现账户 -->
    ...
    <c-dialog :showFlag="delFlag"
      paddingBottom="14px"
      :confirmLoading="confirmLoading"
      @close="delClose"
      @confirm="delConfirm"
      :titleText="$t('assets.b2c.warning')">
      <span>{{ $t('assets.b2c.deleteWarn') }}</span>
    </c-dialog>
...
<script>
import b2cMixin from '@/components/BlockChain-ui-privatization/PC/common-mixin/assets/b2cMixin/b2cMixin';
import mixin from '@/components/BlockChain-ui-privatization/PC/common-mixin/assets/b2cAddressMent/b2cAddressMent';
import '@/components/BlockChain-ui-privatization/PC/common-mixin/assets/b2cAddressMent/b2cAddressMent.styl';
