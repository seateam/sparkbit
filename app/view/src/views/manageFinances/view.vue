<template>
  <div class="manageDetail">
    ...
    <div class="manageDetail-content">
      <div class="detail-content c-4-bg">
        <div class="detailTop c-5-bd">
...
<script>
import mixin from '@/components/BlockChain-ui-privatization/PC/common-mixin/manageFinances/view/view';
import '@/components/BlockChain-ui-privatization/PC/common-mixin/manageFinances/view/view.styl';
