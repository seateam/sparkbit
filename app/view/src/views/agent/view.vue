      ...
      <div class="top-content">
        ...
        <div class="info">
          <div class="info__item">
            <div class="info__item-num">
              {{ teamCount || "-" }} <span class="info__item-symbol"></span>
            </div>
            <div class="info__item-text">{{ $t("agent.teamNum") }}</div>
          </div>
          <div class="info__item">
            <div class="info__item-num">
              {{ reward || "-" }} <span class="info__item-symbol">{{ backSymbol }}</span>
            </div>
...
<style scoped>
.top-wrap {
  background: url("https://chaindown-oss.oss-cn-hongkong.aliyuncs.com/static/1/images/90c51538c13c6e94858d447db23ea83d.png")
    center bottom no-repeat rgb(16, 15, 16);
