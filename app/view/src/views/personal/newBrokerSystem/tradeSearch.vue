<template>
  ...
  <div class="broker-system">
    <p class="user-management-child-header b-1-cl a-3-bd">
      {{ $t("brokerSystem.tradeSearchNavTab[0]") }}
    </p>
...
<script>
import mixin from '@/components/BlockChain-ui-privatization/PC/common-mixin/personal/newBrokerSystem/tradeSearch/tradeSearch';
import '@/components/BlockChain-ui-privatization/PC/common-mixin/personal/newBrokerSystem/tradeSearch/tradeSearch.styl';
