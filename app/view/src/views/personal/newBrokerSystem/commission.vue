<template>
  <div class="broker-system">
    ...
    <div class="date-select-cont clearfix" v-if="currentTab === 2">
      ...
      />
      <c-select
        :promptText="$t('brokerSystem.otherText[0]')"
        class="date-selecter"
        :value="coin"
        :options="coinList"
        :errorHave="true"
...
<script>
import mixin from '@/components/BlockChain-ui-privatization/PC/common-mixin/personal/newBrokerSystem/commission/commission';
import '@/components/BlockChain-ui-privatization/PC/common-mixin/personal/newBrokerSystem/commission/commission.styl';
