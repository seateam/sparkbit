  ...
  <div class="modify-settings">
    ...
    <div class="center clearfix">
      ...
      <c-button
        ...
        width="100%"
        @click="btnLink"
        >{{ $t("personal.tool.confirm") }}</c-button
      >
    </div>
  </div>
</template>
...
<script>
import mixin from "@/components/BlockChain-ui-privatization/PC/common-mixin/personal/modifySettings/modifySettings";
import "@/components/BlockChain-ui-privatization/PC/common-mixin/personal/modifySettings/modifySettings.styl";
