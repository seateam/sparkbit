<template>
  <div class="user-management-change-phone a-5-bg">
    <p class="user-management-child-header b-2-cl a-3-bd a-5-bg">
    ...
    <div class="user-management-center a-5-bg">
      <p class="center-title b-7-cl">
        ...
        </svg>{{$t('personal.prompt.warningChangePhone')}}</p>
...
<script>
import mixin from '@/components/BlockChain-ui-privatization/PC/common-mixin/personal/ChangePhone/ChangePhone';
import '@/components/BlockChain-ui-privatization/PC/common-mixin/personal/ChangePhone/ChangePhone.styl';
