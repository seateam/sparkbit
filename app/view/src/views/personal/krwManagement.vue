<template>
  <div class="user-management krwManagement-container">
    <div class="user-management-header h-1-bg">
            ...
            <div class="li-div a-3-bd b-1-cl clearfix">
              ...
              <div class="li-right clearfix">
                <c-button
                  ...
                  >{{ this.$t("personal.tool.bind") }}</c-button
                >
                <c-button type="text" v-if="krwUserBank" className="li-fun" @click="krwBindBank">
                  {{ this.$t("personal.tool.modify") }}
                </c-button>
                <p class="li-email b-2-cl clearfix" v-if="krwUserBank">{{ krwUserBank.cardNo }}</p>
              </div>
            </div>
          </li>
          <!-- 实名认证 -->
          <li class="li clearfix">
            ...
            <div class="li-div a-3-bd b-1-cl clearfix">
              ...
              <div class="li-right clearfix">
                ...
                <span v-if="authLevel === 0" class="li-fun b-2-cl clearfix li-fun-no">
...
<script>
import mixin from "@/components/BlockChain-ui-privatization/PC/common-mixin/personal/krwManagement/krwManagement";
import "@/components/BlockChain-ui-privatization/PC/common-mixin/personal/krwManagement/krwManagement.styl";
