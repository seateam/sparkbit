  ...
  <div class="broker-system">
    <div class="date-select-cont clearfix">
      ...
      <c-calendar
        ...
        dateInfoTilteClass="f-8-cl"
      />
      <c-select :promptText="$t('brokerSystem.lowerTable1[2]')"
        class="date-selecter"
        :value="coinType"
...
<script>
import mixin from '@/components/BlockChain-ui-privatization/PC/common-mixin/personal/brokerSystem/lowerInfoRebate/lowerInfoRebate';
import '@/components/BlockChain-ui-privatization/PC/common-mixin/personal/brokerSystem/lowerInfoRebate/lowerInfoRebate.styl';
