<template>
  <section class="page-mobility page-mobility-container a-5-bg">
    <!-- 选择币种 -->
    <div class="mobility-sideNav a-3-bd">
      <c-navTab
    ...
    <div class="mobility-content">
      ...
      <!-- 提交按钮 -->
      <c-button width="380px" marginTop="20px"
...
<script>
import mixin from '@/components/BlockChain-ui-privatization/PC/common-mixin/mobility/mobility';
import '@/components/BlockChain-ui-privatization/PC/common-mixin/mobility/mobility.styl';
