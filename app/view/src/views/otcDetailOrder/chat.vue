  ...
  >
    ...
    <div class="chat-content">
      ...
      <div class="chat-server" v-show="tab === 'server'">
        <div :style="{ height: `${chatServerHeight}px` }" class="chat-server-message">
              ...
              >
                ...
                <div class="chat-message">
                  ...
                  <div class="clearfix">
                    ...
                    <!-- 图片 -->
                    <div class="chat-message-img a-2-bg" v-if="item.contentType.toString() === '2'">
        ...
        <div class="chat-send">
          <input
            class="b-1-cl textInput"
            @keyup="serverInpKeyup"
            maxlength="50"
            :placeholder="$t('otcDetailOrder.chatServerInp')"
            v-model="serverInp"
          />
          <div class="sendButton">
            <div class="sendButton-img">
              <span>
                <svg class="icon icon-30" aria-hidden="true">
                  <use xlink:href="#icon-h_3"></use></svg
              ></span>
              <input
                type="file"
                class="files"
            ...
            <c-button
              ...
              name="serverButton"
              @click="serverBtnClick"
              >{{ $t("otcDetailOrder.chatServerBut") }}</c-button
            >
          </div>
        </div>
      </div>
      ...
      <div class="chat-user" v-show="tab === 'user'">
        <div class="chat-user-title">
          ...
          <div class="user-mess">
            ...
            <div class="user-status">
              <div :class="{'inline': userMess.isOnline.toString() === '1'}"></div>
              {{
        ...
        <div class="chat-user-message" :style="{ height: `${chatUserHeight}px` }">
            ...
            <ul ref="userList">
              ...
              >
                <div class="chat-page a-12-bg">
                  <img v-if="item.obj.imageUrl" :src="item.obj.imageUrl" />
        ...
        <div class="chat-send">
          <input
            ...
            maxlength="50"
            ref="userInput"
            :placeholder="$t('otcDetailOrder.chatUserInp')"
            v-model="userInp"
          />
          <div class="sendButton">
            <c-button
...
<script>
import mixin from "@/components/BlockChain-ui-privatization/PC/common-mixin/otcDetailOrder/chat/chat";
import "@/components/BlockChain-ui-privatization/PC/common-mixin/otcDetailOrder/chat/chat.styl";
