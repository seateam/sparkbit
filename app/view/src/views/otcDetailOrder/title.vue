...
<div class="otcDetailOrder-header a-3-bd">
  ...
  <div class="otcDetailOrder-text" v-if="isReady">
    ...
    <div v-if="status === '3' && commonData.side === 'BUY'">
      <!-- 已完成 -->
      <span class="b-7-cl Conspicuous completed">
      ...
      <!-- 划转至币币账户进行交易 -->
      <span class="small">
        {{isCoOpen ? $t('otcDetailOrder.CoCompletedbuy4') : $t('otcDetailOrder.Completedbuy4')}}
      </span>
    </div>
    <!-- 卖 3 -->
    ...
    <div v-if="status === '8' && commonData.side === 'BUY'">
      ...
      <!-- 划转至币币账户进行交易 -->
      <span class="small">
        {{isCoOpen ? $t('otcDetailOrder.CoAfterAppealbuy4') : $t('otcDetailOrder.AfterAppealbuy4')}}
        </span>
    </div>
    <!-- 卖 8 -->
    <div v-if="status === '8' && commonData.side === 'SELL'">
      <!-- 已完成 -->
      <span class="b-7-cl Conspicuous completed">{{ $t('otcDetailOrder.AfterAppealsell') }}</span>
    </div>
  </div>
</div>
</template>
...
<script>
import mixin from '@/components/BlockChain-ui-privatization/PC/common-mixin/otcDetailOrder/title/title';
import '@/components/BlockChain-ui-privatization/PC/common-mixin/otcDetailOrder/title/title.styl';
