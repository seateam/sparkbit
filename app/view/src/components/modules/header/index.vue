    ...
    <template v-if="navigationType === '1' && headerTemplateReceived">
      ...
      <ul class="common-header-linkList">
        ...
        <li class="header-nav-ifl" v-if="subNavisShow">
          ...
          <div class="header-sub-nav h-1-bg">
            <ul v-if="publicInfo" class="header-user-text x-2-cl">
              <li v-if="userInfo && userInfo.agentStatus === 1" class="g-3-cl-h">
                <span
      ...
      <div class="common-header-optionList">
          ...
          >
            ...
            <ul class="lang-list h-1-bg">
              ...
              <li
                ...
                class="b-2-cl"
                :class="hoverMark === item.link ? 'h-4-bg x-1-cl' : ''"
        ...
        <div class="header-user h-2-bd">
          ...
          <div class="header-user-appdown h-1-bg">
            ...
            <div class="download-options-buttons">
              <c-button className="download-button" @click="download('ios_ipa')">
                <svg class="icon icon-18" aria-hidden="true">
        ...
        <div class="header-user h-2-bd" v-if="isLogin && userInfoIsReady">
          ...
          <div class="header-user-market h-1-bg">
            <ul class="header-user-text">
              <li class="x-1-cl userText" @click="btnLink('/personal/userManagement')">
                {{ userText }}
              </li>
              <li class="x-2-cl">
                <!-- 账户状态 -->
      ...
      <div :style="extensionPosition" class="header-sub-nav" v-show="langHover === 'extension'">
        <vue-scroll>
          ...
          >
            ...
            <li v-if="publicInfo && publicInfo.switch.newcoinOpen === '1'" class="x-2-cl g-3-cl-h">
              <span
                @click="btnLink('/innovation')"
...
<script>
import mixin from "@/components/BlockChain-ui-privatization/PC/common-mixin/modules/header/header";
import "@/components/BlockChain-ui-privatization/PC/common-mixin/modules/header/header.styl";
