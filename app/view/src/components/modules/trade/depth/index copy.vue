...
<template>
  <div class="trade-depth-block depath-index-container" :class="depthClass">
    ...
    <div class="depth" ref="depthBox" style="height: 815px">
      ...
      <div :class="{ 'is-show': shrinksDdpthNewShow === 'D' }" class="block-content">
        <tableList
          type="asks"
          :theadList="theadList"
  ...
  methods: {
    init() {
      if (this.moduleType === "lever") {
        // 改，2022.09.24，高度 416 -> 352; 840 -> 600
        // 卖盘 高度
        this.sellHeight = 352;
        // 买盘 高度
        this.buyHeight = 352;
