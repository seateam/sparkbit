  ...
  <div class="trade-box internationalTradeForm b-2-cl">
    ...
    >
      <div class="content">
        <span @mouseenter="handMouseenter">{{
          transactionType == 1 ? $t("trade.limitPriceTrade") : $t("trade.marketPriceTrade")
        }}</span>
    ...
    >
      <div class="content">
        <span @mouseenter="handMouseenter"
          ><!-- 自定义策略 -->{{
            gridType == 1 ? $t("gridTrade.type1") : $t("gridTrade.type2")
          }}</span
        >
        <svg class="icon icon-14" aria-hidden="true">
          <use xlink:href="#icon-a_13"></use>
    ...
    <div class="trade-form trade-grid" v-else>
        ...
        <div class="form-block">
          ...
          <div class="input-inline-box clearfix">
            ...
            <div class="input-inline-item clearfix set-type">
              <div
                class="set-type-btn"
                :class="setType === 1 ? 'u-8-bd u-8-cl' : 'a-3-bd'"
              ...
              <div
                class="set-type-btn"
                :class="setType === 2 ? 'u-8-bd u-8-cl' : 'a-3-bd'"
      ...
      <div class="trade-block trade_block_width" v-if="gridType === 2">
        <div class="form-block">
          <p class="fee_love">
            <span> {{ $t("gridTrade.setText2") }}: </span>
            <b></b>
            <label for="">
              <b>
                {{ $t("gridTrade.aiText1") }}
...
<script>
import "@/components/BlockChain-ui-privatization/PC/common-mixin/modules/trade/tradeForm/internationalTradeForm/internationalTradeForm.styl";
import mixin from "@/components/BlockChain-ui-privatization/PC/common-mixin/modules/trade/tradeForm/internationalTradeForm/internationalTradeForm";
import {
  myStorage,
  fixD,
  division,
      ...
      this.axios({
        ...
        if (req.code.toString() === "0" && req.data) {
          if (Number(req.data.baseAmount) > Number(this.currenTaccount.symbolAccoubt)) {
            this.$bus.$emit("tip", {
              text: `${this.$t("gridTrade.least")}${req.data.baseAmount} ${getCoinShowName(
