...
<script>
import mixin from '@/components/BlockChain-ui-privatization/PC/common-mixin/modules/coTrade/depositMode/depositMode';
import '@/components/BlockChain-ui-privatization/PC/common-mixin/modules/coTrade/depositMode/depositMode.styl';
