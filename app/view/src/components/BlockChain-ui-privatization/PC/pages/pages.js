...
import { callApp } from "../utils/index";
export default {
  name: "app",
  data() {
    return {
      timer: null,
      otcTimer: null, // OTC订单轮询定时器
      hideheade: true,
      hideFooter: false,
      userActivite: false,
      userTime: 0,
