  ...
  computed: {
        ...
        if (Number(this.userInfo.otcCompanyInfo.status)) {
          if (this.userMess.companyLevel === 1) {
            ...
            str = `<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
              <path d="M8.90909 21L7.18182 18.1048L3.90909 17.381L4.22727 14.0333L2 11.5L4.22727 8.96667L3.90909 5.61905L7.18182 4.89524L8.90909 2L12 3.3119L15.0909 2L16.8182 4.89524L20.0909 5.61905L19.7727 8.96667L22 11.5L19.7727 14.0333L20.0909 17.381L16.8182 18.1048L15.0909 21L12 19.6881L8.90909 21ZM11.0455 14.7119L16.1818 9.6L14.9091 8.2881L11.0455 12.1333L9.09091 10.2333L7.81818 11.5L11.0455 14.7119Z" fill="#FFC642"/>
            </svg>`;
          }
        }
      }
    ...
    chatUserHeight() {
      if (this.status === '5' && this.commonData.isComplainUser.toString() === '1') {
        return this.chatHeight - 50 - 64 - 64;
      }
      return this.chatHeight - 64 - 64;
    },
    chatServerHeight() {
      return this.chatHeight - 50 - 64 - 64;
    },
