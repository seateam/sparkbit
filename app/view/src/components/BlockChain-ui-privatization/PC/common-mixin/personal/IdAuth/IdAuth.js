...
const upload1 = imgMap.ID_card;
const upload2 = imgMap.ID_card_back;
const upload3 = imgMap.id_card_handwritten;
const upload7 = imgMap.proof_address;
...
export default {
  ...
  computed: {
    ...
    activeP1() {
      ...
      return "b-2-cl active1";
    },
    activeP2() {
      if (this.active !== "2") {
        return "";
      }
      return "b-2-cl active2";
    },
    activeP3() {
      if (this.active === "3") {
        return "b-2-cl active3";
      }
      return "";
    },
    activeS2() {
  ...
  methods: {
    init() {
      ...
      this.routes = [
        {
          name: this.$t("personal.navMenu.list.userManagement"),
          path: `/ex/${this.lan}/personal/userManagement`,
        },
        {
          name: this.$t("personal.idAuth.title"),
        },
      ];
    },
    getLang() {
    ...
    uploadFinish(obj) {
      ...
      if (this.firstPhotoImg && this.secondPhotoImg && this.thirdPhotoImg && this.fourthPhoto) {
