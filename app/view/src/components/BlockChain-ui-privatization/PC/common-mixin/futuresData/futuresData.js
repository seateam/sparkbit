  ...
  computed: {
    ...
    moreText() {
      let data = {
        ...
        link: 'https://futuresdoc.gitbook.io/help-center/yong-xu-he-yue/untitled-1/bao-xian-ji-jin-yu-fen-tan',
      };
      if (this.tableType === 2) {
        data = {
          text: this.$t('futuresData.moreText2'), //  '了解资金费率',
          link: 'https://futuresdoc.gitbook.io/help-center/yong-xu-he-yue/untitled-1/zi-jin-fei-lv',
        };
      }
      if (this.tableType === 3) {
        data = {
          text: this.$t('futuresData.moreText3'), //  '了解指数价格',
          link: 'https://futuresdoc.gitbook.io/help-center/yong-xu-he-yue/untitled-1/zhi-shu-jia-ge',
        };
      }
      if (this.tableType === 4) {
        data = {
          text: this.$t('futuresData.moreText4'), //  '了解指标记价格',
          link: 'https://futuresdoc.gitbook.io/help-center/yong-xu-he-yue/untitled-1/biao-ji-jia-ge',
        };
      }
      return data;
    },
      ...
      if (dataList && dataList.length) {
        ...
        if (this.tableType === 3) {
          dataList.forEach((item) => {
            arr.push({
              id: item.id,
              data: [item.name, `${fixD(item.weightRate * 100, 2)}%`],
            });
          });
        }
      }
