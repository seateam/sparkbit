...
export default {
  ...
  computed: {
    ...
    calCoinList() {
      const dataList = [{
        value: this.transferObj.baseCoin,
        code: this.transferObj.baseCoin,
        data: this.transferObj.baseCoin,
      }, {
        value: this.transferObj.quoteCoin,
        code: this.transferObj.quoteCoin,
        data: this.transferObj.quoteCoin,
      }];
      return dataList || [];
    },
  },
  methods: {
    ...
    // 切换币种
    transferCoinChange(e) {
      if (this.transferCoin === e.value) return;
      this.transferCoin = e.value;
