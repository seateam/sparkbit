...
export default {
  ...
  computed: {
    ...
    columns() {
      return [
        { title: this.$t("assets.leverageAccount.list1"), width: "10%" }, // 杠杆账户
        ...
        { title: this.$t("assets.leverageAccount.list8"), width: "13%" }, // 操作
      ];
    },
    market() {
  ...
  methods: {
    ...
    // 处理列表数据
    async setData({ totalBalance, totalBalanceSymbol, leverMap }) {
      this.tabelLoading = false;
        ...
        list.push({
          ...
          data: [
            ...
            [
              ...
              {
                type: "link", // 'link' ' button' ,'html', 'label', 'icon' ‘str’
                text: this.$t("h5Add.tradeList1"), // 交易
                eventType: "goTrade",
              },
            ],
          ],
