...
export default {
  ...
  <path d="M6.90909 19L5.18182 16.1048L1.90909 15.381L2.22727 12.0333L0 9.5L2.22727 6.96667L1.90909 3.61905L5.18182 2.89524L6.90909 0L10 1.3119L13.0909 0L14.8182 2.89524L18.0909 3.61905L17.7727 6.96667L20 9.5L17.7727 12.0333L18.0909 15.381L14.8182 16.1048L13.0909 19L10 17.6881L6.90909 19ZM9.04545 12.7119L14.1818 7.6L12.9091 6.2881L9.04545 10.1333L7.09091 8.23333L5.81818 9.5L9.04545 12.7119Z" fill="#6A60FF"/>
            ...
            str = `<svg xmlns="http://www.w3.org/2000/svg" width="20" height="19" viewBox="0 0 20 19" fill="none">
  <path d="M6.90909 19L5.18182 16.1048L1.90909 15.381L2.22727 12.0333L0 9.5L2.22727 6.96667L1.90909 3.61905L5.18182 2.89524L6.90909 0L10 1.3119L13.0909 0L14.8182 2.89524L18.0909 3.61905L17.7727 6.96667L20 9.5L17.7727 12.0333L18.0909 15.381L14.8182 16.1048L13.0909 19L10 17.6881L6.90909 19ZM9.04545 12.7119L14.1818 7.6L12.9091 6.2881L9.04545 10.1333L7.09091 8.23333L5.81818 9.5L9.04545 12.7119Z" fill="#FFC642"/>
</svg>`;
          }
        }
      }
    ...
    leftInputOptions() {
      ...
      let warningText = "";
      const { side, payCoin, coin, minTrade, maxTrade } = this.axiosObj;
      if (side === "SELL") {
        // 用 法币 买 数字货币
        promptText += ` (${payCoin})`;
        // 下单金额范围
    ...
    messageTitle() {
      ...
      if (side && coin && payCoin) {
        str = `${this.$t("otcTrade.use")}
          ${payCoin}
          ${side === "BUY" ? this.$t("otcTrade.sell") : this.$t("otcTrade.buy")} ${this.getShowCoin(
          coin
        )}`;
      }
      return str;
