...
export default {
  ...
  computed: {
    // 币种信息
    marginCoinInfor() {
      if (this.$store.state.future && this.$store.state.future.marginCoinInfor) {
        // console.log(this.$store.state.future,'this.$store.state.future')
    ...
    // 保证金币种列表
    marginCoinList() {
      if (this.$store.state.future && this.$store.state.future.marginCoinList) {
    ...
    // 用户合约资产
    accountBalanceMap() {
      if (this.$store.state.future && this.$store.state.future.futureAccountBalance) {
    ...
    // 限制转入
    fundsInStatus() {
      if (this.marginCoinInfor && this.axiosSymbol && this.marginCoinInfor[this.axiosSymbol]) {
