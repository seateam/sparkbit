import {
  nul, fixD, division, thousandsComma, getCookie, myStorage, imgMap
} from '@/utils';
...
export default {
  ...
  data() {
    return {
      ...
      icon_play: imgMap.icon_play,
      icon_spot: imgMap.icon_spot
    };
  },
  computed: {
    lantext() {
    ...
    // 2022.12.29 新增market coinList curCoinIcon
    market() {
    ...
    // 当前币种icon
    curCoinIcon() {
      if (this.contractInfo && this.coinList) {
        let coinName = this.contractInfo.base;
        return this.coinList[coinName] ? this.coinList[coinName].icon : ""
      }
    },
  },
  watch: {
