  ...
  <section class="wh_container">
    <div class="wh_content_all">
      ...
      <div class="wh_content">
        <div class="wh_content_item" v-for="(tag, index) in textTop" :key="index + 'tag'">
...
export default {
  ...
  methods: {
    ...
    getList(date, chooseDay) {
      ...
      this.dateTop = `${mm[date.getMonth()]} ${date.getFullYear()}`;
...
.wh_top_changge li:not(.wh_content_li) {
  width: 24px;
  height: 24px;
}
