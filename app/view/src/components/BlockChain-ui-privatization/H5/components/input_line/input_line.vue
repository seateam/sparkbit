  ...
  <section class="input-line-content" :style="contentStyle" :class="className">
    ...
    >
      ...
      <div
        ...
        style="bottom: unset; color: #aaaaaa; width: 90%"
      >
...
export default {
  ...
  props: {
    ...
    haveCopy: { default: false, type: Boolean }, // 是否有粘贴
  },
  created() {
  ...
  methods: {
    ...
    copyClick() {
      ...
      // input.select();
      this.$refs.aaa.setSelectionRange(0, 100);
      ...
      // this.$emit('onchanges', '123', this.name);
    },
    promptClick() {
      if (this.focusTime) {
