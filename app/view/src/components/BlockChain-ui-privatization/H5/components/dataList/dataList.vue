          ...
          >
            <ul class="data-list">
              ...
              >
                ...
                <div v-if="line.handle" class="t-body">
                  <div
                    ...
                    >
                      ...
                      <div class="select-box a-5-bg" v-show="selectIsOpenId === line.id">
                        <ul class="select-box-ul">
                          <li
                            :style="`${
                              btnItem.selectWidth ? 'width: ' + btnItem.selectWidth + 'px' : ''
                            }`"
              ...
              >
                <div v-if="columns[i]" :class="[classHead, columns[i].classes]">
                  {{ columns[i].title }}
                </div>
...
export default {
  ...
  computed: {
    ...
    classBody() {
      const cls =
        this.isType(this.bodyClasses) === "Array" ? [...this.bodyClasses] : this.bodyClasses;
