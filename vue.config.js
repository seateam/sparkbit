...
const InlineHtmlPlugin = require("./app/view/src/components/BlockChain-ui-privatization/webpack-plugin/inline-html.js");
...
module.exports = {
  transpileDependencies: ["BlockChain-ui-privatization", "vue-script2"],
  ...
  devServer: {
    ...
    proxy: {
      fePublicInfo: {
        target: "https://www.sparkbit.io/",
      },
      "/fe-ex-api": {
        target: "https://www.sparkbit.io/fe-ex-api",
        pathRewrite: {
          "^/fe-ex-api": "",
        },
        changeOrigin: true, // 将 host 修改为 target
        headers: {
          "x-forwarded-host": "webapi.testwww.hiotc.pro",
        },
      },
      "fe-quant-api": {
        target: "https://www.sparkbit.io/",
      ...
      "/fe-financing-api": {
        target: "https://www.sparkbit.io/financing/",
        pathRewrite: {
          "^/fe-financing-api": "",
        },
      },
      "/fe-otc-api": {
        target: "https://www.sparkbit.io/fe-otc-api",
        pathRewrite: {
          "^/fe-otc-api": "",
        },
        changeOrigin: true, // 将 host 修改为 target
      ...
      "/fe-co-api": {
        target: "https://futures.sparkbit.io/fe-co-api",
        pathRewrite: {
          "^/fe-co-api": "",
        },
      },
      ...
      "/fe-openapi-api": {
        target: "https://openapi.sparkbit.io/",
        changeOrigin: true, // 将 host 修改为 target
        pathRewrite: {
          "^/fe-openapi-api": "",
        },
